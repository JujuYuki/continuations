...
\begin{myproof}
	...
	\begin{itemize}
		\item[i:] cutting rules for neutrals:
			\[
				\begin{prooftree}
		...
		\item[ii:] cutting rules for atoms:
			\[
				\begin{prooftree}
					\hypo{A_x \vdash x:a}
...
\end{myproof}
\remark The next step is to introduce recieving and sending rules with adequate markings and translations to have them work with the system (and potentially replace the rules for atoms).
\end{document}