...
\end{myproof}
%%TODO: Prove that these rules, along with neutral, construction and cut rules, and with usual $\pi$-calculus reduction, keep the typing for reduction.\\
...
%% NOT NECESSARY WITH THE NEW CUT RULE -> nu does nothing (or at worst introduces \bot, which is neutral and can be simplified in MELL)
%%TODO: Adapt and prove the "confluence"/"congruence" up to permutation on independent names.
\end{document}